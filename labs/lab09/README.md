# Протокол BGP (eBGP). Основы

## Цель

Организовать IP связность между пограничным роутерами офисов Москва и Санкт-Петербург.

## Задание

1. Настроить eBGP между офисом Москва и двумя провайдерами - Киторн и Ламас.
1. Настроить eBGP между провайдерами Киторн и Ламас.
1. Настроить eBGP между Ламас и Триада.
1. Настроить eBGP между Киторн и Триада.
1. Настроить eBGP между офисом Санкт-Петербург и провайдером Триада.
1. Проверить IP связность между пограничным роутерами офисов Москва и Санкт-Петербург.
...
[Схема для импорта в PNETlab](media/otus_cource_lab9_eBGP(basic)_pnetlab_export-20250118-195716.zip)
