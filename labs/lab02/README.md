# Построение Switched Network with Redundant Links 

## Задание

[Ссылка на документ](media/lab02.docx)

## Топология

![a](media/lab02_1.PNG)

[Схема для импорта в PNETlab](media/otus_cource_lab2_stp_pnetlab_export-20241017-205853.zip)

## Версии ПО

- PNETlab - 5.3.11
- Роутеры (при их наличии на схеме) - Cisco IOS Software [Dublin], Linux Software (X86_64BI_LINUX-ADVENTERPRISEK9-M), Version  17.12.1, RELEASE SOFTWARE (fc5)
- Коммутаторы (при их наличии на схеме) - Cisco IOS Software [Dublin], Linux Software (X86_64BI_LINUX_L2-ADVENTERPRISEK9-M), Version 17.12.1, RELEASE SOFTWARE (fc5)
...
S3 | VLAN 1 | 192.168.1.3 | 255.255.255.0 | N/A
