...
1. Настроить GRE между офисами Москва и Санкт-Петербург.
      ...
      Так как все внутренние подсети (10.X.X.X/16) филиалов Москва, Санкт-Петербург, Чокурдак, Лабытнанги должны быть доступны через GRE, соответственно, эти подсети не должны быть анонсированы в сторону провайдеров Интернет (за исключением пула адресов, используемых для NAT, а именно: 10.10.13.0/24 и 10.10.14.0/24 в Москве, 10.50.52.0/25 и 10.50.52.128/25 в Санкт-Петербурге). На устройствах R42 и R43 нужно убрать статические маршруты до внутренних подсетей офисов Лабытнанги и Чокурдак.
...
1. Настроить DMVPN (без шифрования) между офисами Москва и Чокурдак, Лабытнанги.
      ...
      Архитектура - Dual Cloud Dual Hub (phase 2).  
...
1. Проверка GRE между офисами Москва и Санкт-Петербург.
      ...
      Дополнительная информация о работе протоколов GRE, BGP приведена в главе "Конфигурации устройств".
